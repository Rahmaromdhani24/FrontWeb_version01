...
@Component({
  selector: 'app-page-pdek-pistolet-vert',
  standalone: true,
  imports: [
    NgApexchartsModule,
    MatCardModule,
  ...
  providers: [],
  templateUrl: './page-pdek-pistolet-vert.component.html',
  styleUrl: './page-pdek-pistolet-vert.component.scss'
})
export class PagePdekPistoletVertComponent implements OnInit ,AfterViewInit  {
  pages: {
    pageNum: number;
    pistolets: Pistolet[];

...
@Component({
  selector: 'app-page-pdek-pistolet-jaune',
  standalone: true,
  imports: [
    NgApexchartsModule,
    MatCardModule,
  ...
  providers: [],
  templateUrl: './page-pdek-pistolet-jaune.component.html',
  styleUrl: './page-pdek-pistolet-jaune.component.scss'
})
export class PagePdekPistoletJauneComponent implements OnInit ,AfterViewInit  {
  pages: {
    pageNum: number;
    pistolets: Pistolet[];

...
@Component({
  selector: 'app-add-plan-action-sertissage-idc',
imports: [ MatFormFieldModule,
  ...
  templateUrl: './add-plan-action-sertissage-idc.component.html',
  styleUrl: './add-plan-action-sertissage-idc.component.scss'
})
export class AddPlanActionSertissageIDCComponent implements OnInit {
...
submitForm() {
  ...
  if (this.myForm.valid) {
    ...
    this.serviceChefLigne.ajouterPlanActionSertissageIDC(pdekId, numeroPage,userId,  idSoudure , detailsPlanAction).subscribe({
      next: (data) => {

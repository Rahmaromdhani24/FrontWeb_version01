...
@Component({
  selector: 'app-add-user-operateur',
  imports: [ 
        MatSelectModule,
        FormsModule,
        ReactiveFormsModule,
        ...
        MatCheckboxModule,
        TablerIconsModule],
 templateUrl: './add-user-operateur.component.html',
  styleUrl: './add-user-operateur.component.scss'
})
export class AddUserOperateurComponent  implements OnInit {
adminForm: FormGroup;
plants: string[] = [];
...
ngOnInit(): void {
  ...
  this.service.addOperateur(operateur).subscribe({
next: () => {
  Swal.fire('Succès', 'Opérateur ajouté avec succès !', 'success');

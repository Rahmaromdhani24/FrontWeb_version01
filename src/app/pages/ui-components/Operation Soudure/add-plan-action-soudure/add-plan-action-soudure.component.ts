...
imports: [ MatFormFieldModule,
  ...
  templateUrl: './add-plan-action-soudure.component.html',
  styleUrl: './add-plan-action-soudure.component.scss'
})
export class AddPlanActionSoudureComponent implements OnInit {
 ...
 constructor(private router: Router , private serviceChefLigne : ChefLigneService , 
              ...
              public  general :GeneralService  ,  private cdr : ChangeDetectorRef) {}
...
submitForm() {
  ...
  if (this.myForm.valid) {
    ...
    this.serviceChefLigne.ajouterPlanActionSoudure(pdekId, numeroPage,userId,  idSoudure , detailsPlanAction).subscribe({
      next: (data) => {
